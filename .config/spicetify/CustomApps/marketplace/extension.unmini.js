!(async function () {
    ...
    var e, t, i, l, _, u, F, U, T, D, r, c, n, V, B, q, z, f, h, o, C, p, K, H, J, W, a, G, Y, X, Z, s, d, g, b, m, v, Q, y, ee, te, w, re, ne, ae, k, x, oe, S, se;
    (i = Object.create),
            ...
            "node_modules/.pnpm/chroma-js@2.4.2/node_modules/chroma-js/chroma.js"(e, t) {
                ...
                (r = function () {
                    ...
                    function D() {
                        ...
                        (r = i.format[o].apply(null, r ? e : e.slice(0, -1))), (this._rgb = G(r)), 3 === this._rgb.length && this._rgb.push(1);
                    }
                    function n() {
                        for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                    ...
                    function V() {
                        ...
                        var r = (e = Q(e, "cmyk"))[0],
                            ...
                            o = e[3],
                            s = 4 < e.length ? e[4] : 1;
                        return 1 === o ? [0, 0, 0, s] : [1 <= r ? 0 : 255 * (1 - r) * (1 - o), 1 <= n ? 0 : 255 * (1 - n) * (1 - o), 1 <= a ? 0 : 255 * (1 - a) * (1 - o), s];
                    }
                    function a(e) {
                    ...
                    function B() {
                        ...
                        return (
                            ...
                            a == l ? (n = (o - s) / (l - i)) : o == l ? (n = 2 + (s - a) / (l - i)) : s == l && (n = 4 + (a - o) / (l - i)),
                            (n *= 60) < 0 && (n += 360),
                    ...
                    function z() {
                        ...
                        if (0 === s) r = n = a = 255 * i;
                            ...
                            for (var h = 0; h < 3; h++) l[h] < 0 && (l[h] += 1), 1 < l[h] && --l[h], (u[h] = 6 * l[h] < 1 ? f + 6 * (c - f) * l[h] : 2 * l[h] < 1 ? c : 3 * l[h] < 2 ? f + (c - f) * (2 / 3 - l[h]) * 6 : f);
                    ...
                    function K(e) {
                        ...
                        return (t = e.match(we)) ? (((r = t.slice(1, 4))[1] *= 0.01), (r[2] *= 0.01), ((r = de(r))[3] = 1), r) : (t = e.match(ke)) ? (((r = t.slice(1, 4))[1] *= 0.01), (r[2] *= 0.01), ((e = de(r))[3] = +t[4]), e) : void 0;
                    }
                    var H = r,
                        J = r,
                        o = Math.PI,
                        e = {
                            clip_rgb: function (e) {
                                ...
                                for (var t = 0; t <= 3; t++) t < 3 ? ((e[t] < 0 || 255 < e[t]) && (e._clipped = !0), (e[t] = _(e[t], 0, 255))) : 3 === t && (e[t] = _(e[t], 0, 1));
                                return e;
                            },
                            limit: e,
                            type: r,
                        ...
                        ue = function () {
                            ...
                            return (
                                ...
                                (r[1] = a(100 * r[1]) + "%"),
                                (r[2] = a(100 * r[2]) + "%"),
                                "hsla" === n || (3 < r.length && r[3] < 1) ? ((r[3] = 3 < r.length ? r[3] : 1), (n = "hsla")) : (r.length = 3),
                                n + "(" + r.join(",") + ")"
                            );
                        },
                        ce = B,
                    ...
                    function Le() {
                        ...
                        var r = (o = Ze(e, "rgba"))[0],
                            ...
                            o = o[3],
                            s = Qe(e) || "auto",
                            i = (void 0 === o && (o = 1), "auto" === s && (s = o < 1 ? "rgba" : "rgb"), (i = "000000" + ((f(r) << 16) | (f(n) << 8) | f(a)).toString(16)).substr(i.length - 6)),
                    ...
                    function Oe(e) {
                        var t;
                        if (e.match(et))
                            return 3 === (e = 4 !== e.length && 7 !== e.length ? e : e.substr(1)).length && (e = (e = e.split(""))[0] + e[0] + e[1] + e[1] + e[2] + e[2]), [(t = parseInt(e, 16)) >> 16, (t >> 8) & 255, 255 & t, 1];
                        if (e.match(tt))
                            return (
                                4 === (e = 5 !== e.length && 9 !== e.length ? e : e.substr(1)).length && (e = (e = e.split(""))[0] + e[0] + e[1] + e[1] + e[2] + e[2] + e[3] + e[3]),
                                [((t = parseInt(e, 16)) >> 24) & 255, (t >> 16) & 255, (t >> 8) & 255, Math.round(((255 & t) / 255) * 100) / 100]
                            );
                    ...
                    function Ce() {
                        ...
                        return (
                            ...
                            [
                                (a =
                                    116 * (n = (r = [It((0.4124564 * r + 0.3575761 * n + 0.1804375 * a) / d.Xn), It((0.2126729 * r + 0.7151522 * n + 0.072175 * a) / d.Yn), It((0.0193339 * r + 0.119192 * n + 0.9503041 * a) / d.Zn)])[1]) -
                                    16) < 0
                                    ? 0
                                    : a,
                                500 * (r[0] - n),
                    ...
                    function Me() {
                        ...
                        return (
                            ...
                            (n = g.Xn * je(n)),
                            (a = g.Zn * je(a)),
                            [Pe(3.2404542 * n - 1.5371385 * r - 0.4985314 * a), Pe(-0.969266 * n + 1.8760108 * r + 0.041556 * a), Pe(0.0556434 * n - 0.2040259 * r + 1.0572252 * a), 3 < e.length ? e[3] : 1]
                        );
                    }
                    function Ee() {
                        for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                        ...
                        var t,
                            ...
                            n =
                                (e = e / 100) < 66
                                    ...
                                    : ((t = 351.97690566805693 + 0.114206453784165 * (t = e - 55) - 40.25366309332127 * w(t)), (r = 325.4494125711974 + 0.07943456536662342 * (r = e - 50) - 28.0852963507957 * w(r)), 255);
                        return [t, r, n, 1];
                    }
                    function Ue() {
                        for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                        ...
                        return [0.2104542553 * o + 0.793617785 * s - 0.0040720468 * n, 1.9779984951 * o - 2.428592205 * s + 0.4505937099 * n, 0.0259040371 * o + 0.7827717662 * s - 0.808675766 * n];
                    }
                    var u = l,
                        Te = s,
                        c = o,
                        ...
                        Xe = function () {
                            ...
                            var r,
                                ...
                                i = Math.max(a, o, n),
                                l = i - s;
                            return 0 == l ? (r = Number.NaN) : (a === i && (r = (o - n) / l), o === i && (r = 2 + (n - a) / l), n === i && (r = 4 + (a - o) / l), (r *= 60) < 0 && (r += 360)), [r, (100 * l) / 255, (s / (255 - l)) * 100];
                        },
                        Ze =
                        ...
                        bt = function () {
                            ...
                            var r,
                                ...
                                i = (a + o + n) / 3,
                                s = 0 < i ? 1 - s / i : 0;
                            return 0 == s ? (r = NaN) : ((r = (a - o + (a - n)) / 2), (r /= lt((a - o) * (a - o) + (a - n) * (o - n))), (r = ut(r)), o < n && (r = st - r), (r /= st)), [360 * r, s, i];
                        },
                        mt =
                        ...
                        Pt = function () {
                            ...
                            var r,
                                ...
                                l = St(a, o, s),
                                i = l - i;
                            return 0 === l ? ((r = Number.NaN), (n = 0)) : ((n = i / l), a === l && (r = (o - s) / i), o === l && (r = 2 + (s - a) / i), s === l && (r = 4 + (a - o) / i), (r *= 60) < 0 && (r += 360)), [r, n, l / 255];
                        },
                        c =
                            ...
                            { Kn: 18, Xn: 0.95047, Yn: 1, Zn: 1.08883, t0: 0.137931034, t1: 0.206896552, t2: 0.12841855, t3: 0.008856452 }),
                        d = c,
                        jt = e.unpack,
                        Mt = Math.pow,
                        Et = function (e) {
                        ...
                        w =
                            ...
                            v.autodetect.push({
                                ...
                                test: function () {
                                    for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                                    if (((e = br(e, "rgba")), "array" === mr(e) && (3 === e.length || (4 === e.length && "number" == mr(e[3]) && 0 <= e[3] && e[3] <= 1)))) return "rgb";
                                },
                            }),
                            Math.log),
                        yr = Fe,
                        ...
                        Sr =
                            ...
                            (u.temp = u.kelvin = u.temperature = function () {
                                for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                    ...
                    Jr.prototype.alpha = function (e, t) {
                        return void 0 === t && (t = !1), void 0 !== e && "number" === Wr(e) ? (t ? ((this._rgb[3] = e), this) : new Jr([this._rgb[0], this._rgb[1], this._rgb[2], e], "rgb")) : this._rgb[3];
                    };
                    ...
                    function Yr(e, t, r) {
                        ...
                        var o = n[0] || "lrgb";
                        if ((N[o] || n.length || (o = Object.keys(N)[0]), N[o])) return "object" !== an(e) && (e = new nn(e)), "object" !== an(t) && (t = new nn(t)), N[o](e, t, r).alpha(e.alpha() + r * (t.alpha() - e.alpha()));
                    ...
                    function L(e, t, r, n) {
                        ...
                        return (
                            ...
                            ("h" !== n.substr(0, 1) && "oklch" !== n) || ((o = (e = p)[0]), (i = e[1]), (u = e[2]), (s = (t = a)[0]), (l = t[1]), (c = t[2])),
                            isNaN(o) || isNaN(s)
                                ? isNaN(o)
                                    ? isNaN(s)
                                        ? (h = Number.NaN)
                    ...
                    function Zr(u) {
                        function r(e) {
                            if (((e = e || ["#fff", "#000"]) && "string" === P(e) && C.brewer && C.brewer[e.toLowerCase()] && (e = C.brewer[e.toLowerCase()]), "array" === P(e))) {
                        ...
                        return (
                            ...
                            (f.classes = function (e) {
                                var t;
                                return null != e ? ("array" === P(e) ? (h = [(d = e)[0], e[e.length - 1]]) : ((t = C.analyze(h)), (d = 0 === e ? [t.min, t.max] : C.limits(t, "e", e))), f) : d;
                            }),
                            (f.domain = function (r) {
                            ...
                            (f.correctLightness = function (e) {
                                return (
                                    ...
                                    (x = (e = null == e ? !0 : e)
                                        ? function (e) {
                                              for (var t = c(0, !0).lab()[0], r = c(1, !0).lab()[0], n = r < t, a = c(e, !0).lab()[0], o = t + (r - t) * e, s = a - o, i = 0, l = 1, u = 20; 0.01 < Math.abs(s) && 0 < u--; )
                                                  n && (s *= -1), (e += s < 0 ? 0.5 * (l - (i = e)) : 0.5 * (i - (l = e))), (a = c(e, !0).lab()[0]), (s = a - o);
                                              return e;
                                          }
                                        : function (e) {
                                              return e;
                            ...
                            (f.colors = function (t, r) {
                                ...
                                if (0 === arguments.length) e = g.slice(0);
                                    ...
                                    var n = h[0],
                                        a = h[1] - n,
                                        e = (function (e, t, r) {
                                            for (var n = [], a = e < t, o = r ? (a ? t + 1 : t - 1) : t, s = e; a ? s < o : o < s; a ? s++ : s--) n.push(s);
                                            return n;
                                    ...
                                    u = [];
                                    var o = [];
                                    if (d && 2 < d.length) for (var s = 1, i = d.length, l = 1 <= i; l ? s < i : i < s; l ? s++ : s--) o.push(0.5 * (d[s - 1] + d[s]));
                                    else o = h;
                                    e = o.map(f);
                                }
                                return (e = C[r]
                    ...
                    var O = s,
                        ...
                        ln =
                            ((sn.prototype.premultiply = function (e) {
                                var t = this._rgb,
                                    r = t[3];
                                return (e = void 0 === e ? !1 : e) ? ((this._rgb = [t[0] * r, t[1] * r, t[2] * r, r]), this) : new sn([t[0] * r, t[1] * r, t[2] * r, r], "rgb");
                            }),
                            s),
                        un = c,
                        cn =
                        ...
                        gn =
                            ((o.lrgb = function (e, t, r) {
                                var e = e._rgb,
                                    ...
                                    s = t[1],
                                    t = t[2];
                                return new pn(dn(R(n, 2) * (1 - r) + R(o, 2) * r), dn(R(a, 2) * (1 - r) + R(s, 2) * r), dn(R(e, 2) * (1 - r) + R(t, 2) * r), "rgb");
                            }),
                            s),
                        bn =
                            ...
                            Zn = function (e, t) {
                                ...
                                return (
                                    (e = "object" === Jn(e) ? Object.values(e) : e).forEach(function (e) {
                                        null == (e = t && "object" === Jn(e) ? e[t] : e) || isNaN(e) || (r.values.push(e), (r.sum += e), e < r.min && (r.min = e), r.max < e && (r.max = e), (r.count += 1));
                                    }),
                    ...
                    return (
                        (s.average = function (e, o, s) {
                            ...
                            for (var h, p = e.shift(), d = p.get(o), g = [], b = 0, m = 0, v = 0; v < d.length; v++)
                                (d[v] = (d[v] || 0) * s[0]), g.push(isNaN(d[v]) ? 0 : s[0]), "h" !== o.charAt(v) || isNaN(d[v]) || ((h = (d[v] / 180) * Pn), (b += jn(h) * s[0]), (m += Mn(h) * s[0]));
                            var y = p.alpha() * s[0];
                            e.forEach(function (e, t) {
                                var r = e.get(o);
                                y += e.alpha() * s[t + 1];
                                for (var n, a = 0; a < d.length; a++) isNaN(r[a]) || ((g[a] += s[t + 1]), "h" === o.charAt(a) ? ((n = (r[a] / 180) * Pn), (b += jn(n) * s[t + 1]), (m += Mn(n) * s[t + 1])) : (d[a] += r[a] * s[t + 1]));
                            });
                            ...
                            var t = (function (e) {
                                if (
                                    ...
                                    var t,
                                        ...
                                        s = function (t) {
                                            var e = [0, 1, 2].map(function (e) {
                                                return (1 - t) * (1 - t) * (1 - t) * r[e] + 3 * (1 - t) * (1 - t) * t * n[e] + 3 * (1 - t) * t * t * a[e] + t * t * t * o[e];
                                            });
                                            return new j(e, "lab");
                                        };
                                else {
                        ...
                        (s.cubehelix = function (a, o, s, i, l) {
                            ...
                            function t(e) {
                                var t = Tn * ((a + 120) / 360 + o * e),
                                    ...
                                    n = Bn(t),
                                    t = Vn(t);
                                return qn(Un([255 * (r + e * (-0.14861 * n + 1.78277 * t)), 255 * (r + e * (-0.29227 * n - 0.90649 * t)), 255 * (r + 1.97294 * n * e), 1]));
                            }
                            var u,
                                c = 0;
                    ...
                    "object" == typeof (e = e) && void 0 !== t ? (t.exports = r()) : "function" == typeof define && define.amd ? define(r) : ((e = "undefined" != typeof globalThis ? globalThis : e || self).chroma = r());
            },
        }),
        (T = function () {
        ...
        (z = new (class {
            ...
            getRegExp(e) {
                ...
                return void 0 !== t || ((t = new RegExp(e)), this.regExpQueue.length === this.capacity && this.regExpMap.delete(this.regExpQueue.shift()), this.regExpMap.set(e, t), this.regExpQueue.push(e)), t;
            }
        })(20)),
        (f = class extends n {
            constructor(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : { ns: ["translation"], defaultNS: "translation" };
            ...
            getResource(e, t, r) {
                ...
                let o;
                -1 < e.indexOf(".") ? (o = e.split(".")) : ((o = [e, t]), r && (Array.isArray(r) ? o.push(...r) : "string" == typeof r && a ? o.push(...r.split(a)) : o.push(r)));
                var s = N(this.data, o);
                return !s && !t && !r && -1 < e.indexOf(".") && ((e = o[0]), (t = o[1]), (r = o.slice(2).join("."))), s || !n || "string" != typeof r ? s : P(this.data && this.data[e] && this.data[e][t], r, a);
            }
            addResource(e, t, r, n) {
                var a = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : { silent: !1 },
                    o = (void 0 !== a.keySeparator ? a : this.options).keySeparator;
                let s = [e, t];
                r && (s = s.concat(o ? r.split(o) : r)), -1 < e.indexOf(".") && ((n = t), (t = (s = e.split("."))[1])), this.addNamespaces(t), ue(this.data, s, n), a.silent || this.emit("added", e, t, r, n);
            }
            addResources(e, t, r) {
                var n = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : { silent: !1 };
                for (const a in r) ("string" != typeof r[a] && "[object Array]" !== Object.prototype.toString.apply(r[a])) || this.addResource(e, t, a, r[a], { silent: !0 });
            ...
            addResourceBundle(e, t, r, n, a) {
                ...
                let s = [e, t],
                    i = (-1 < e.indexOf(".") && ((n = r), (r = t), (t = (s = e.split("."))[1])), this.addNamespaces(t), N(this.data, s) || {});
                o.skipCopy || (r = JSON.parse(JSON.stringify(r))), n ? fe(i, r, a) : (i = { ...i, ...r }), ue(this.data, s, i), o.silent || this.emit("added", e, t, r);
            }
        ...
        (C = class extends n {
            constructor(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                super(),
                    le(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this),
                    (this.options = t),
            ...
            extractFromKey(e, t) {
                ...
                var o = r && -1 < e.indexOf(r),
                    t = !(this.options.userDefinedKeySeparator || t.keySeparator || this.options.userDefinedNsSeparator || t.nsSeparator || pe(e, r, n));
                if (o && !t) {
            ...
            translate(r, n, a) {
                if (((n = (n = "object" == typeof (n = "object" != typeof n && this.options.overloadTranslationOptionHandler ? this.options.overloadTranslationOptionHandler(arguments) : n) ? { ...n } : n) || {}), null == r)) return "";
                ...
                if (l && "cimode" === l.toLowerCase())
                    return u
                        ? ((u = n.nsSeparator || this.options.nsSeparator), e ? { res: "" + i + u + s, usedKey: s, exactUsedKey: s, usedLng: l, usedNS: i, usedParams: this.getUsedParamsDetails(n) } : "" + i + u + s)
                        : e
                ...
                if (g && c && b && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(p) < 0 && ("string" != typeof d || "[object Array]" !== p)) {
                    if (!n.returnObjects && !this.options.returnObjects)
                        return (
                            this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!"),
                            (b = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(f, c, { ...n, ns: t }) : `key '${s} (${this.language})' returned an object instead of string.`),
                    ...
                    if (o) {
                        var m,
                            ...
                            v = b ? [] : {},
                            y = b ? h : f;
                        for (const k in c) Object.prototype.hasOwnProperty.call(c, k) && ((m = "" + y + o + k), (v[k] = this.translate(m, { ...n, joinArrays: !1, ns: t })), v[k] === m) && (v[k] = c[k]);
                        c = v;
                    }
                } else if (g && "string" == typeof d && "[object Array]" === p) c = (c = c.join(d)) && this.extendTranslation(c, r, n, a);
                else {
                    let e = !1,
                        t = !1;
                    b = void 0 !== n.count && "string" != typeof n.count;
                    const x = C.hasDefaultValue(n);
                    (h = b ? this.pluralResolver.getSuffix(l, n.count, n) : ""), (f = n.ordinal && b ? this.pluralResolver.getSuffix(l, n.count, { ordinal: !1 }) : "");
                    const S = b && !n.ordinal && 0 === n.count && this.pluralResolver.shouldUseIntlApi(),
                        L = (S && n[`defaultValue${this.options.pluralSeparator}zero`]) || n["defaultValue" + h] || n["defaultValue" + f] || n.defaultValue,
                        O = (!this.isValidLookup(c) && x && ((e = !0), (c = L)), this.isValidLookup(c) || ((t = !0), (c = s)), (n.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && t ? void 0 : c),
                    ...
                    if (t || e || N) {
                        ...
                        const R = (e, t, r) => {
                            r = x && r !== c ? r : O;
                            this.options.missingKeyHandler ? this.options.missingKeyHandler(e, i, t, r, N, n) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(e, i, t, r, N, n),
                        ...
                        this.options.saveMissing &&
                            (this.options.saveMissingPlurals && b
                                ? t.forEach((t) => {
                                      ...
                                      S && n[`defaultValue${this.options.pluralSeparator}zero`] && e.indexOf(this.options.pluralSeparator + "zero") < 0 && e.push(this.options.pluralSeparator + "zero"),
                                          e.forEach((e) => {
                    ...
                    (c = this.extendTranslation(c, r, n, u, a)),
                        ...
                        (t || e) &&
                            ...
                            (c = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? i + ":" + s : s, e ? c : void 0) : this.options.parseMissingKeyHandler(c));
                }
                return e ? ((u.res = c), (u.usedParams = this.getUsedParamsDetails(n)), u) : c;
            }
            extendTranslation(r, n, a, o, s) {
                var i = this;
                if (this.i18nFormat && this.i18nFormat.parse) r = this.i18nFormat.parse(r, { ...this.options.interpolation.defaultVariables, ...a }, a.lng || this.language || o.usedLng, o.usedNS, o.usedKey, { resolved: o });
                else if (!a.skipInterpolation) {
                    a.interpolation && this.interpolator.init({ ...a, interpolation: { ...this.options.interpolation, ...a.interpolation } });
                    var l = "string" == typeof r && (a && a.interpolation && void 0 !== a.interpolation.skipOnVariables ? a : this.options).interpolation.skipOnVariables;
                    let e,
                        t = (l && ((u = r.match(this.interpolator.nestingRegexp)), (e = u && u.length)), a.replace && "string" != typeof a.replace ? a.replace : a);
                    this.options.interpolation.defaultVariables && (t = { ...this.options.interpolation.defaultVariables, ...t }),
                        ...
                        !1 !== a.nest &&
                            (r = this.interpolator.nest(
                                ...
                                function () {
                                    for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                                    return s && s[0] === t[0] && !a.context ? (i.logger.warn(`It seems you are nesting recursively key: ${t[0]} in key: ` + n[0]), null) : i.translate(...t, n);
                                },
                                a
                            )),
                ...
                return (r =
                    null != r && l && l.length && !1 !== a.applyPostProcessor
                        ? h.handle(l, r, n, this.options && this.options.postProcessPassResolved ? { i18nResolved: { ...o, usedParams: this.getUsedParamsDetails(a) }, ...a } : a, this)
                        : r);
            }
            resolve(e) {
                    ...
                    (e = "string" == typeof e ? [e] : e).forEach((t) => {
                        if (!this.isValidLookup(h)) {
                            ...
                            const l = void 0 !== f.count && "string" != typeof f.count,
                                ...
                                c = void 0 !== f.context && ("string" == typeof f.context || "number" == typeof f.context) && "" !== f.context,
                                ...
                                this.isValidLookup(h) ||
                                    ...
                                    r.forEach((t) => {
                                        if (!this.isValidLookup(h)) {
                                            ...
                                            var e,
                                                r = [i];
                                            if (this.i18nFormat && this.i18nFormat.addLookupKeys) this.i18nFormat.addLookupKeys(r, i, t, s, f);
                                            else {
                                                let e;
                                                ...
                                                l && (r.push(i + e), f.ordinal && 0 === e.indexOf(o) && r.push(i + e.replace(o, this.options.pluralSeparator)), u) && r.push(i + a),
                                                    c &&
                                                        ((n = "" + i + this.options.contextSeparator + f.context), r.push(n), l) &&
                                                        (r.push(n + e), f.ordinal && 0 === e.indexOf(o) && r.push(n + e.replace(o, this.options.pluralSeparator)), u) &&
                                                        r.push(n + a);
                                            }
            ...
            getResource(e, t, r) {
                var n = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : {};
                return (this.i18nFormat && this.i18nFormat.getResource ? this.i18nFormat : this.resourceStore).getResource(e, t, r, n);
            }
            getUsedParamsDetails() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                    t = e.replace && "string" != typeof e.replace;
                let r = t ? e.replace : e;
                if ((t && void 0 !== e.count && (r.count = e.count), this.options.interpolation.defaultVariables && (r = { ...this.options.interpolation.defaultVariables, ...r }), !t)) {
                    r = { ...r };
                    for (const n of ["defaultValue", "ordinal", "context", "replace", "lng", "lngs", "fallbackLng", "ns", "keySeparator", "nsSeparator", "returnObjects", "returnDetails", "joinArrays", "postProcess", "interpolation"])
                        delete r[n];
                }
                return r;
            }
            static hasDefaultValue(e) {
                var t = "defaultValue";
                for (const r in e) if (Object.prototype.hasOwnProperty.call(e, r) && t === r.substring(0, t.length) && void 0 !== e[r]) return !0;
                return !1;
            }
        }),
        (p = class {
            ...
            getScriptPartFromCode(e) {
                return !(e = j(e)) || e.indexOf("-") < 0 || 2 === (e = e.split("-")).length || (e.pop(), "x" === e[e.length - 1].toLowerCase()) ? null : this.formatLanguageCode(e.join("-"));
            }
                ...
                if ("string" == typeof t && -1 < t.indexOf("-")) {
                    ...
                    return (
                        this.options.lowerCaseLng
                            ...
                            : 2 === e.length
                            ? ((e[0] = e[0].toLowerCase()), (e[1] = e[1].toUpperCase()), -1 < r.indexOf(e[1].toLowerCase()) && (e[1] = M(e[1].toLowerCase())))
                            : 3 === e.length &&
                              ((e[0] = e[0].toLowerCase()),
                        ...
                        e.forEach((e) => {
                            if (!r) {
                                ...
                                r = this.options.supportedLngs.find((e) =>
                                    e === t || (!(e.indexOf("-") < 0 && t.indexOf("-") < 0) && ((0 < e.indexOf("-") && t.indexOf("-") < 0 && e.substring(0, e.indexOf("-")) === t) || (0 === e.indexOf(t) && 1 < t.length))) ? e : void 0
                                );
                            }
                        }),
            ...
            getFallbackCodes(e, t) {
                if (!e) return [];
                if (("string" == typeof (e = "function" == typeof e ? e(t) : e) && (e = [e]), "[object Array]" === Object.prototype.toString.apply(e))) return e;
                if (!t) return e.default || [];
                let r = e[t];
                return (r = (r = (r = (r = r || e[this.getScriptPartFromCode(t)]) || e[this.formatLanguageCode(t)]) || e[this.getLanguagePartFromCode(t)]) || e.default) || [];
            }
        ...
        (G = class {
            ...
            getPluralFormsOfKey(e, t) {
                return this.getSuffixes(e, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).map((e) => "" + t + e);
            }
            getSuffixes(t) {
            ...
            getSuffixRetroCompatible(e, t) {
                ...
                return "v1" === this.options.compatibilityJSON
                    ? 1 === r
                        ...
                        ? "_plural_" + r.toString()
                        : n()
                    : "v2" === this.options.compatibilityJSON || (this.options.simplifyPluralSuffix && 2 === e.numbers.length && 1 === e.numbers[0])
                    ? n()
        ...
        (Y = class {
            constructor() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                (this.logger = c.create("interpolator")), (this.options = e), (this.format = (e.interpolation && e.interpolation.format) || ((e) => e)), this.init(e);
            }
            init() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            interpolate(n, r, a, o) {
                ...
                const c = (e) => {
                        ...
                        return e.indexOf(this.formatSeparator) < 0
                            ? ((t = ge(r, u, e, this.options.keySeparator, this.options.ignoreJSONStructure)), this.alwaysFormat ? this.format(t, void 0, a, { ...o, ...r, interpolationkey: e }) : t)
                            : ((e = (t = e.split(this.formatSeparator)).shift().trim()),
                              (t = t.join(this.formatSeparator).trim()),
                              this.format(ge(r, u, e, this.options.keySeparator, this.options.ignoreJSONStructure), t, a, { ...o, ...r, interpolationkey: e }));
                    },
                    f = (this.resetRegExp(), (o && o.missingInterpolationHandler) || this.options.missingInterpolationHandler),
                    h = (o && o.interpolation && void 0 !== o.interpolation.skipOnVariables ? o : this.options).interpolation.skipOnVariables;
                return (
                    [
                        ...
                        for (l = 0; (s = e.regex.exec(n)); ) {
                            ...
                            r = e.safeValue(i);
                            if (((n = n.replace(s[0], r)), h ? ((e.regex.lastIndex += i.length), (e.regex.lastIndex -= s[0].length)) : (e.regex.lastIndex = 0), ++l >= this.maxReplaces)) break;
                        }
                    }),
                    n
                );
            ...
            nest(r, n) {
                ...
                for (; (o = this.nestingRegexp.exec(r)); ) {
                    let e = [],
                        t = (((i = (i = { ...a }).replace && "string" != typeof i.replace ? i.replace : i).applyPostProcessor = !1), delete i.defaultValue, !1);
                    var u;
                    if (
                        (-1 === o[0].indexOf(this.formatSeparator) || /{.*}/.test(o[1]) || ((u = o[1].split(this.formatSeparator).map((e) => e.trim())), (o[1] = u.shift()), (e = u), (t = !0)),
                        (s = n(l.call(this, o[1].trim(), i), i)) && o[0] === r && "string" != typeof s)
                    )
                        return s;
                    (s = "string" != typeof s ? ie(s) : s) || (this.logger.warn(`missed to resolve ${o[1]} for nesting ` + r), (s = "")),
        ...
        (Z = class extends n {
                    ...
                    e.forEach((r) => {
                        ...
                        t.forEach((e) => {
                            ...
                            !a.reload && this.store.hasResourceBundle(r, e)
                                ? (this.state[t] = 2)
                                : this.state[t] < 0 || (1 === this.state[t] ? void 0 === s[t] && (s[t] = !0) : ((this.state[t] = 1), (n = !1), void 0 === s[t] && (s[t] = !0), void 0 === o[t] && (o[t] = !0), void 0 === l[e] && (l[e] = !0)));
                        }),
                            n || (i[r] = !0);
                    }),
                    (Object.keys(o).length || Object.keys(s).length) && this.queue.push({ pending: s, pendingCount: Object.keys(s).length, loaded: {}, errors: [], callback: r }),
                    { toLoad: Object.keys(o), pending: Object.keys(s), toLoadLanguages: Object.keys(i), toLoadNamespaces: Object.keys(l) }
                );
            }
            loaded(e, t, r) {
                var n = e.split("|");
                const a = n[0],
                    o = n[1],
                    s = (t && this.emit("failedLoading", a, o, t), r && this.store.addResourceBundle(a, o, r, void 0, void 0, { skipCopy: !0 }), (this.state[e] = t ? -1 : 2), {});
            ...
            read(n, a, o) {
                ...
                if (this.readingCalls >= this.maxParallelReads) this.waitingReads.push({ lng: n, ns: a, fcName: o, tried: s, wait: i, callback: l });
                else {
                    this.readingCalls++;
                    const r = (e, t) => {
                        var r;
                        this.readingCalls--,
                            0 < this.waitingReads.length && ((r = this.waitingReads.shift()), this.read(r.lng, r.ns, r.fcName, r.tried, r.wait, r.callback)),
            ...
            loadOne(r) {
                ...
                this.read(a, o, "read", void 0, void 0, (e, t) => {
                    e && this.logger.warn(`${n}loading namespace ${o} for language ${a} failed`, e), !e && t && this.logger.log(`${n}loaded namespace ${o} for language ` + a, t), this.loaded(r, e, t);
                });
            }
                ...
                if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(r))
                    ...
                    if (this.backend && this.backend.create) {
                        ...
                        if (o.length < 6)
                            try {
                                let e;
                                (e = 5 === o.length ? o(t, r, n, a, s) : o(t, r, n, a)) && "function" == typeof e.then ? e.then((e) => i(null, e)).catch(i) : i(null, e);
                            } catch (e) {
                                i(e);
                            }
                        else o(t, r, n, a, i, s);
        ...
        (s = class extends n {
            constructor() {
                ...
                if ((super(), (this.options = ye(e)), (this.services = {}), (this.logger = c), (this.modules = { external: [] }), we(this), t && !this.isInitialized && !e.isClone)) {
            ...
            init() {
                ...
                if (
                    ...
                    "v1" !== this.options.compatibilityAPI && (this.options.interpolation = { ...t.interpolation, ...this.options.interpolation }),
                    ...
                    (s.logger = c),
                        ...
                        (s.languageUtils = o),
                        (s.pluralResolver = new G(o, { prepend: this.options.pluralSeparator, compatibilityJSON: this.options.compatibilityJSON, simplifyPluralSuffix: this.options.simplifyPluralSuffix })),
                        !e ||
                            (this.options.interpolation.format && this.options.interpolation.format !== t.interpolation.format) ||
                            ((s.formatter = n(e)), s.formatter.init(s, this.options), (this.options.interpolation.format = s.formatter.format.bind(s.formatter))),
                        ...
                        this.modules.languageDetector && ((s.languageDetector = n(this.modules.languageDetector)), s.languageDetector.init) && s.languageDetector.init(s, this.options.detection, this.options),
                        this.modules.i18nFormat && ((s.i18nFormat = n(this.modules.i18nFormat)), s.i18nFormat.init) && s.i18nFormat.init(this),
                ...
                (this.format = this.options.interpolation.format),
                    (r = r || I),
                    !this.options.fallbackLng || this.services.languageDetector || this.options.lng || (0 < (o = this.services.languageUtils.getFallbackCodes(this.options.fallbackLng)).length && "dev" !== o[0] && (this.options.lng = o[0])),
            ...
            loadResources(e) {
                ...
                if (("function" == typeof e && (t = e), !this.options.resources || this.options.partialBundledLanguages)) {
                    if (r && "cimode" === r.toLowerCase() && (!this.options.preload || 0 === this.options.preload.length)) return t();
                    const n = [],
                        a = (e) => {
                            e &&
                                "cimode" !== e &&
            ...
            changeLanguage(r, n) {
                ...
                const o = L(),
                    ...
                    i = (e, t) => {
                        t ? (s(t), this.translator.changeLanguage(t), (this.isLanguageChangingTo = void 0), this.emit("languageChanged", t), this.logger.log("languageChanged", t)) : (this.isLanguageChangingTo = void 0),
                            o.resolve(function () {
                ...
                var e = (e) => {
                    const t = "string" == typeof (e = r || e || !this.services.languageDetector ? e : []) ? e : this.services.languageUtils.getBestMatchFromCodes(e);
                    t &&
                        (this.language || s(t), this.translator.language || this.translator.changeLanguage(t), this.services.languageDetector) &&
            ...
            getFixedT(e, t, l) {
                ...
                function c(e, t) {
                    ...
                    (r.lng = r.lng || c.lng), (r.lngs = r.lngs || c.lngs), (r.ns = r.ns || c.ns), (r.keyPrefix = r.keyPrefix || l || c.keyPrefix);
                    const s = u.options.keySeparator || ".";
                    let i;
                    return (i = r.keyPrefix && Array.isArray(e) ? e.map((e) => "" + r.keyPrefix + s + e) : r.keyPrefix ? "" + r.keyPrefix + s + e : e), u.t(i, r);
                }
            ...
            hasLoadedNamespace(e) {
                ...
                return !!this.hasResourceBundle(r, e) || !(this.services.backendConnector.backend && (!this.options.resources || this.options.partialBundledLanguages) && (!o(r, e) || (n && !o(a, e))));
            }
            loadNamespaces(e, t) {
                const r = L();
            ...
            loadLanguages(e, t) {
                ...
                e = (e = "string" == typeof e ? [e] : e).filter((e) => n.indexOf(e) < 0 && this.services.languageUtils.isSupportedCode(e));
                return e.length
            ...
            dir(e) {
                var t;
                return !(e = e || this.resolvedLanguage || (this.languages && 0 < this.languages.length ? this.languages[0] : this.language)) ||
            ...
            static createInstance() {
                return new s(0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, 1 < arguments.length ? arguments[1] : void 0);
            }
            cloneInstance() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        (m = ((e, t, r) => {
            ...
            var n = !t && e && e.__esModule ? r : l(r, "default", { value: e, enumerable: !0 }),
                ...
                o = void 0,
                s = void 0;
            if ((a && "object" == typeof a) || "function" == typeof a) for (let e of u(a)) U.call(n, e) || e === o || l(n, e, { get: () => a[e], enumerable: !(s = _(a, e)) || s.enumerable });
            return n;
        })(T())),
        (v = (t, e) => {
        ...
        (y = (e, t) => {
            let r = [];
            return e && 0 < e.length ? (r = e.map((e) => ({ name: e.name, url: oe(e.url) }))) : r.push({ name: t, url: "https://github.com/" + t }), r;
        }),
        (ee = (...e) => {
        ...
        (ne = async (e, t) => {
            var r = v(g.albumArtBasedColorMode)
                .replace(/([A-Z])/g, "-$1")
                .toLowerCase();
            return (await fetch(`https://www.thecolorapi.com/scheme?hex=${e}&mode=${r}&count=` + t).then((e) => e.json())).colors.map((e) => e.hex.value.substring(1));
        }),
        (ae = (h) => {
        ...
        (x = (e) => {
            e = e.match(/https:\/\/raw\.githubusercontent\.com\/(?<user>[^/]+)\/(?<repo>[^/]+)\/(?<branch>[^/]+)\/(?<filePath>.+$)/);
            return { user: e ? e.groups?.user : null, repo: e ? e.groups?.repo : null, branch: e ? e.groups?.branch : null, filePath: e ? e.groups?.filePath : null };
        }),
        (oe = (e) => {
        ...
        (S = (e) => {
            e && (e = e.split("/").pop()) && -1 === Spicetify.Config.extensions.indexOf(e) && Spicetify.Config.extensions.push(e);
        }),
        (n = new Blob(
            [
                `
...
`,
        ...
        (async function e() {
            if (Spicetify.LocalStorage && Spicetify.showNotification) {
                ...
                (t.innerHTML = "const global = globalThis;"), document.body.appendChild(t), console.log("Initializing Spicetify Marketplace v1.0.2"), (window.Marketplace = { reset: ee, export: te, version: "1.0.2" });
                const l = await xe();
                t = async (t) => {
                    t = v(t);
                    if (t) {
                        if ((console.debug("Initializing theme: ", t), t.schemes)) {
                            ...
                            if ((w(e), (Spicetify.Config.color_scheme = t.activeScheme), "true" === localStorage.getItem(g.albumArtBasedColor))) ae(e);
                        ...
                        (e = document.querySelector("link.marketplaceCSS")),
                            (e =
                                ...
                                await (async (e, t) => {
                                    ...
                                    t ||= await xe();
                                    var t = k(e.cssURL) ? `https://cdn.jsdelivr.${t}/gh/${e.user}/${e.repo}@${e.branch}/` + e.manifest.usercss : e.cssURL,
                                    ...
                                    for (const s of n.matchAll(/url\(['|"](?<path>.+?)['|"]\)/gm) || []) {
                                        var a,
                                            o = s?.groups?.path;
                                        !o || o.startsWith("http") || o.startsWith("data") || ((a = r + o.replace(/\.\//g, "")), (n = n.replace(o, a)));
                                    }
                                    return n;
                                })(t, l)));
                        try {
                            ...
                            s && s.remove(),
                                e
                                    ? ((n = document.createElement("style")).classList.add("marketplaceCSS"), n.classList.add("marketplaceUserCSS"), (n.innerHTML = e), document.body.appendChild(n))
                                    : ((a = document.createElement("link")).setAttribute("rel", "stylesheet"), a.setAttribute("href", "user.css"), a.classList.add("userCSS"), document.body.appendChild(a));
                        } catch (e) {
                            console.warn(e);
                        }
                        (Spicetify.Config.current_theme = t.manifest?.name),
                            t.include &&
                                ...
                                t.include.forEach((e) => {
                                    ...
                                    (t.src = r + "?time=" + Date.now()), t.classList.add("marketplaceScript"), document.body.appendChild(t), S(e);
                                });
...
`),
                    ...
                    l
                        ? (window.sessionStorage.setItem("marketplace-request-tld", l),
                          (n = (v(g.installedExtensions, []).forEach((e) => {
                              if ((e = v(e)) && e.extensionURL) {
                                  ...
                                  if (((t.defer = !0), (t.src = e.extensionURL), k(t.src))) {
                                      ...
                                      if (!(r && n && a && o)) return;
                                      (t.src = `https://cdn.jsdelivr.${l}/gh/${r}/${n}@${a}/` + o), o.endsWith(".mjs") && (t.type = "module");
                                  }
                          ...
                          (r = localStorage.getItem(g.themeInstalled)) && ("marketplace" !== n.toLocaleLowerCase() ? Spicetify.showNotification(d("notifications.wrongLocalTheme"), !0, 5e3) : t(r)))
                        : window.navigator.onLine
                        ? (console.error(new Error("Unable to connect to the CDN, please check your Internet configuration.")), Spicetify.showNotification(d("notifications.noCdnConnection"), !0, 5e3))
        ...
        (async function () {
            ...
            window.sessionStorage.setItem("marketplace:blacklist", JSON.stringify(e)), await Promise.all([A("extension", 0), A("theme", 0), A("app", 0)]);
        })();
    function L() {
        let r, n;
    ...
    function ue(n, a, o) {
        ...
        if (void 0 !== e || 1 === a.length) e[t] = o;
            ...
            let e = a[a.length - 1],
                ...
                r = O(n, t, Object);
            for (; void 0 === r.obj && t.length; ) (e = t[t.length - 1] + "." + e), (t = t.slice(0, t.length - 1)), (r = O(n, t, Object)) && r.obj && void 0 !== r.obj[r.k + "." + e] && (r.obj = void 0);
            r.obj[r.k + "." + e] = o;
        }
    }
    function ce(e, t, r, n) {
    ...
    function fe(e, t, r) {
        for (const n in t)
            "__proto__" !== n && "constructor" !== n && (n in e ? ("string" == typeof e[n] || e[n] instanceof String || "string" == typeof t[n] || t[n] instanceof String ? r && (e[n] = t[n]) : fe(e[n], t[n], r)) : (e[n] = t[n]));
    }
    function R(e) {
        return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
    }
        ...
        if (e) {
            ...
            for (let n = 0; n < s.length; ) {
                ...
                for (let e = n; e < s.length; ++e)
                    if ((e !== n && (r += o), (r += s[e]), void 0 !== (t = a[r]) && !(-1 < ["string", "number", "boolean"].indexOf(typeof t) && e < s.length - 1))) {
                        n += e - n + 1;
                        break;
                    }
                a = t;
    ...
    async function xe() {
        for (const e of ["net", "xyz"])
            try {
                if ("opaqueredirect" === (await fetch("https://cdn.jsdelivr." + e, { redirect: "manual", cache: "no-cache" })).type) return e;
            } catch (e) {
                console.error(e);
                continue;
            }
    ...
    async function $(e, t, r) {
        ...
        let s = await (async function (e) {
            ...
            return new Promise((t) => {
                ...
                n.postMessage(e), n.addEventListener("message", (e) => r(e.data), { once: !0 }), n.addEventListener("error", () => r(null), { once: !0 });
            });
        })(a);
    ...
    async function A(e, t) {
        var r = await (async function (e, t = 1) {
                ...
                let n = `https://api.github.com/search/repositories?per_page=${b}&q=` + encodeURIComponent(`topic:spicetify-${e}s`);
                t && (n += "&page=" + t);
                var a =
                    ...
                    (await fetch(n)
                        ...
                        .catch(() => null));
                return a?.items
                    ? (window.sessionStorage.setItem(`spicetify-${e}s-page-` + t, JSON.stringify(a)), { ...a, page_count: a.items.length, items: a.items.filter((e) => !r?.includes(e.html_url)) })
                                      ...
                                      return (await $(o, s, n)).reduce((e, t) => {
                                          var r = t.branch || n,
                                              r = {
                                                  ...
                                                  repo: s,
                                                  branch: r,
                                                  imageURL: t.preview && t.preview.startsWith("http") ? t.preview : `https://raw.githubusercontent.com/${o}/${s}/${r}/` + t.preview,
                                                  readmeURL: t.readme && t.readme.startsWith("http") ? t.readme : `https://raw.githubusercontent.com/${o}/${s}/${r}/` + t.readme,
                                                  stars: a,
                                                  tags: t.tags,
                                                  cssURL: t.usercss.startsWith("http") ? t.usercss : `https://raw.githubusercontent.com/${o}/${s}/${r}/` + t.usercss,
                                                  schemesURL: t.schemes ? (t.schemes.startsWith("http") ? t.schemes : `https://raw.githubusercontent.com/${o}/${s}/${r}/` + t.schemes) : null,
                                                  include: t.include,
                                              };
                                      ...
                                      return (await $(s, i, n)).reduce((e, t) => {
                                          var r = t.branch || n,
                                              r = {
                                                  ...
                                                  repo: i,
                                                  branch: r,
                                                  imageURL: t.preview && t.preview.startsWith("http") ? t.preview : `https://raw.githubusercontent.com/${s}/${i}/${r}/` + t.preview,
                                                  extensionURL: t.main.startsWith("http") ? t.main : `https://raw.githubusercontent.com/${s}/${i}/${r}/` + t.main,
                                                  readmeURL: t.readme && t.readme.startsWith("http") ? t.readme : `https://raw.githubusercontent.com/${s}/${i}/${r}/` + t.readme,
                                                  stars: a,
                                                  tags: t.tags,
                                              };
                                          return t && t.name && t.description && t.main && ((o && localStorage.getItem(`marketplace:installed:${s}/${i}/` + t.main)) || e.push(r)), e;
                                      }, []);
                                  } catch {
                                      return;
                                  }
