...
vim.keymap.set('n', '<M-t>', ':tabnew<CR>', { desc = 'Open [N]ew Tab' })
        ...
        rust_analyzer = function()
          require('lspconfig').rust_analyzer.setup {
            settings = {
              ['rust_analyzer'] = {
                rustfmt = {
                  extraArgs = { '+nightly', '--edition=2021', '--config-path', '$XDG_CONFIG_HOME/rustfmt/rustfmt.toml' },
                },
              },
            },
          }
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = {
          ...
          ['⟨'] = cmp.mapping.select_prev_item(), -- RCtrl + [ in keyboard layout
          -- Select the [n]ext item
          ['<C-n>'] = cmp.mapping.select_next_item(),
          ['⟩'] = cmp.mapping.select_next_item(), -- RCtrl + ] in keyboard layout
