...
- Warnings are no longer duplicated. Workaround for [GHC issue [#18068](https://github.com/dramforever/vscode-ghc-simple/issues/18068)](https://gitlab.haskell.org/ghc/ghc/issues/18068).
